...
import { getFocusableElements, isDirectBackdropClick, lockDocumentScroll, trapDialogFocus } from "./dialog-behavior.mjs";
...
export default function Modal({ children, className = "", initialFocusSelector, onClose, titleId }: ModalProps) {
  ...
  useEffect(() => {
    ...
    const animationFrame = window.requestAnimationFrame(() => {
      const requestedTarget = initialFocusSelector ? dialog.querySelector<HTMLElement>(initialFocusSelector) : null;
